...
type FilterFunctionObject<T> = (
  x: T,
  prop: string,
  inputObj: Dictionary<T>
) => boolean
type MapFunctionObject<T, U> = (
  x: T,
  prop: string,
  inputObj: Dictionary<T>
) => U
...
type Merge<Primary, Secondary> = {[K in keyof Primary]: Primary[K]} &
{
  [K in Exclude<
  keyof Secondary,
  CommonKeys<Primary, Secondary>
  >]: Secondary[K]
}
...
export function and<
  T extends
  | {and?: (...a: readonly any[]) => any}
  | number
  | boolean
  | string
  | null
>(fn1: T, val2: any): boolean
export function and<
  T extends
  | {and?: (...a: readonly any[]) => any}
  | number
...
export function anyPass<T>(
  predicates: readonly SafePred<T>[]
): SafePred<T>

/**
 * It adds element `x` at the end of `listOrString`.
 */
export function append<T>(x: T, listOrString: readonly T[]): T[]
export function append<T>(x: T): <T>(listOrString: readonly T[]) => T[]
...
export function assoc<K extends string>(
  prop: K
): <T, U>(newValue: T, obj: U) => Record<K, T> & U
...
export function assocPath<T, U>(path: Path, newValue: T): (obj: U) => U
export function assocPath<T, U>(
  path: Path
): FunctionToolbelt.Curry<(a: T, b: U) => U>
...
export function cond(
  conditions: [Pred, (...a: readonly any[]) => any][]
): (...a: readonly any[]) => any
export function cond<A, B>(
  conditions: [SafePred<A>, (...a: readonly A[]) => B][]
): (...a: readonly A[]) => B
...
export function defaultTo<T>(
  defaultValue: T
): (...inputArguments: (T | null | undefined)[]) => T
export function defaultTo<T>(
  defaultValue: T,
  ...inputArguments: (T | null | undefined)[]
): T
export function defaultTo<T, U>(
  defaultValue: T | U,
...
export function filter<T, U>(
  predicate: FilterFunctionObject<T>
...
export function flatten<T>(
  x: readonly T[] | readonly T[][] | readonly (readonly T[])[]
): T[]
...
export function flip<
  ...
  P extends FunctionToolbelt.Parameters<F>
>(
  fn: F
): FunctionToolbelt.Curry<
(
  ...args: TupleToolbelt.Merge<[P[1], P[0]], P>
) => FunctionToolbelt.Return<F>
>
...
export function forEach<T>(
  fn: (value: T, key: string, obj: {[key: string]: T}) => void,
  obj: {[key: string]: T}
): void
export function forEach<T>(
  fn: (value: T, key: string, obj: {[key: string]: T}) => void
): (obj: {[key: string]: T}) => void

/**
 * It transforms a `listOfPairs` to an object.
 */
export function fromPairs<V>(
  listOfPairs: KeyValuePair<string, V>[]
): {[index: string]: V}
export function fromPairs<V>(
  listOfPairs: KeyValuePair<number, V>[]
): {[index: number]: V}
...
export function groupBy<T>(
  groupFn: (a: T) => string
): (list: readonly T[]) => {[index: string]: T[]}
 ...
 */
export function init<T>(listOrString: readonly T[]): T[]
 ...
 */
export function length<T>(listOrString: readonly T[]): number
...
): FunctionToolbelt.Curry<(x: T, y: T) => T>
...
export function pathOr<T>(
  defaultValue: T
): FunctionToolbelt.Curry<(a: Path, b: any) => T>
 ...
 */
export function pickAll<T, U>(propsToPick: readonly string[], obj: T): U
 ...
 */
export function pluck<T>(property: number, list: readonly T[]): T
export function pluck<K extends keyof T, T>(
  property: K,
  list: readonly T[]
): T[K][]
export function pluck(property: number): <T>(list: readonly T[]) => T
export function pluck<P extends string>(
  property: P
): <T>(list: readonly Record<P, T>[]) => T[]

/**
 * It adds element `x` at the beginning of `listOrString`.
 */
export function prepend<T>(x: T, listOrString: readonly T[]): T[]
export function prepend<T>(x: T): (listOrString: readonly T[]) => T[]
...
export function prop<P extends string>(
  p: P
): <T>(propToFind: Record<P, T>) => T
export function prop<P extends string, T>(
  p: P
 ...
 */
export function reverse<T>(listOrString: readonly T[]): T[]
 ...
 */
export function tail<T>(listOrString: readonly T[]): T[]
export function tail(listOrString: string): string

/**
 * It returns the first `howMany` elements of `listOrString`.
 */
export function take<T>(howMany: number, listOrString: readonly T[]): T[]
...
export function when<T>(
  rule: Func<boolean>,
  resultOrFunction: T | IdentityFunction<T>
): IdentityFunction<T>
export function when<T>(
  rule: Func<boolean>
