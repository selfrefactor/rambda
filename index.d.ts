...
type ReturnTypeOfLastInTuple<TFunctions extends AnyFunction[]> = ReturnType<LastInTuple<TFunctions>>;

type ParametersOfFirstInTuple<TFunctions extends AnyFunction[]> = Parameters<TFunctions[0]>;
