...
describe('throttle', () => {
  ...
  it('arity of 2', () => {
    /*
      ...
      The whole issue is descipted in the skipped test suite.
    */
...
/*
  Stop fixing this problem at R.repeat, so there should be more cases
  Revert changes as origin of this issue is unknown.
*/
