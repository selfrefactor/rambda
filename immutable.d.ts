...
type CondPair<T extends readonly any[], R> = readonly [
  (...val: T) => boolean,
  (...val: T) => R
]
...
type ProduceRules<Output, K extends keyof Output, Input> = {
  readonly [P in K]: (input: Input) => Output[P]
}
type ProduceAsyncRules<Output, K extends keyof Output, Input> = {
  readonly [P in K]: (input: Input) => Promise<Output[P]>
}
...
type Resolved<T> =
  ...
  | {readonly status: 'rejected'; readonly reason: string | Error}
 ...
 */
export function complement<T extends readonly any[]>(
 ...
 */
export function cond<T extends readonly any[], R>(
  conditions: ReadonlyArray<CondPair<T, R>>
): (...args: T) => R
...
export function converge(
  ...
  fns: readonly ((...x: readonly any[]) => any)[]
): (...y: readonly any[]) => any
...
export function countBy<T extends unknown>(
  transformFn: (x: T) => any
): (list: readonly T[]) => Record<string, number>
...
): (input: readonly T[]) => readonly (readonly T[])[]
export function groupWith<T>(
  compareFn: (x: T, y: T) => boolean,
  input: readonly T[]
): readonly (readonly T[])[]
...
export function init<T extends readonly unknown[]>(
  input: T
): T extends readonly [...infer U, any] ? U : readonly [...T]
 ...
 */
export function juxt<A extends readonly any[], R1>(
  fns: readonly [(...a: A) => R1]
): (...a: A) => readonly [R1]
export function juxt<A extends readonly any[], R1, R2>(
  fns: readonly [(...a: A) => R1, (...a: A) => R2]
): (...a: A) => readonly [R1, R2]
export function juxt<A extends readonly any[], R1, R2, R3>(
  fns: readonly [(...a: A) => R1, (...a: A) => R2, (...a: A) => R3]
): (...a: A) => readonly [R1, R2, R3]
export function juxt<A extends readonly any[], R1, R2, R3, R4>(
  fns: readonly [
    (...a: A) => R1,
    (...a: A) => R2,
    (...a: A) => R3,
...
): (...a: A) => readonly [R1, R2, R3, R4]
export function juxt<A extends readonly any[], R1, R2, R3, R4, R5>(
  fns: readonly [
    (...a: A) => R1,
    (...a: A) => R2,
    (...a: A) => R3,
...
): (...a: A) => readonly [R1, R2, R3, R4, R5]
export function juxt<A extends readonly any[], U>(
...
export function over(
  lens: Lens,
  fn: Arity1Fn
): <T>(value: readonly T[]) => readonly T[]
export function over(lens: Lens): <T>(fn: Arity1Fn, value: T) => T
export function over(
  lens: Lens
): <T>(fn: Arity1Fn, value: readonly T[]) => readonly T[]
...
>(path: readonly [K0, K1], obj: S): S[K0][K1]
export function path<
  S,
  K0 extends keyof S = keyof S,
  K1 extends keyof S[K0] = keyof S[K0],
...
export function pluck<T>(
  property: number,
  list: readonly {readonly [k: number]: T}[]
): readonly T[]
export function pluck<P extends string>(
  property: P
): <T>(list: readonly Record<P, T>[]) => readonly T[]
export function pluck(
  property: number
): <T>(list: readonly {readonly [k: number]: T}[]) => readonly T[]
 ...
 */
export function prop<P extends keyof never, T>(
  propToFind: P,
  value: T
): Prop<T, P>
export function prop<P extends keyof never>(
  propToFind: P
): {
...
export function propIs<C extends AnyConstructor, K extends keyof any>(
  type: C,
  name: K,
  obj: any
...
export function props<P extends string>(
  propsToPick: readonly P[]
): <T>(obj: Record<P, T>) => readonly T[]
export function props<P extends string, T>(
  propsToPick: readonly P[]
): (obj: Record<P, T>) => readonly T[]
...
export function range(
  startInclusive: number
): (endExclusive: number) => readonly number[]
...
export function reduce<T, TResult>(
  reducer: (prev: TResult, current: T, i?: number) => TResult
): (initialValue: TResult, list: readonly T[]) => TResult
export function reduce<T, TResult>(
  reducer: (prev: TResult, current: T, i?: number) => TResult,
  initialValue: TResult
...
export function tail<T extends readonly unknown[]>(
  input: T
): T extends readonly [any, ...infer U] ? U : readonly [...T]
...
>(
  obj: O
): ReadonlyArray<{readonly [key in K]: readonly [`${key}`, O[key]]}[K]>
export function toPairs<S>(
  obj: Record<string | number, S>
): ReadonlyArray<readonly [string, S]>
...
export function zipObj<K extends string>(
  keys: readonly K[]
): <T>(values: readonly T[]) => {readonly [P in K]: T}
